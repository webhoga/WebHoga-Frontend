          ...
          <div class="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto fade-in-up">
            ...
            <div
              ...
              <div class="relative z-10">
                {/* Icon */}
                <div
                  class="w-20 h-20 bg-gradient-to-br from-orange-500 to-amber-500 rounded-3xl flex items-center justify-center text-white text-3xl mb-6 group-hover:scale-110 transition-transform duration-300">
                  🏨
                </div>
              ...
              <div class="relative z-10">
                ...
                <div class="bg-gradient-to-r from-blue-50 to-cyan-50 p-4 rounded-xl mb-6 border border-blue-100">
                  <div class="text-center">
                    ...
                    <div class="text-3xl font-bold text-blue-700">₹1,25,000</div>
          ...
          <div class="max-w-4xl mx-auto fade-in-up">
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-slate-100">
              <div class="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div class="text-center">
                  <div
                    class="w-32 h-32 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full flex items-center justify-center text-white text-4xl mx-auto mb-6">
                    🚀
                  </div>
                  <a
