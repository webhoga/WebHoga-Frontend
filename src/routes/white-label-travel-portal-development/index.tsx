...
export const head: DocumentHead = {
  title: "White Label Travel Portal Development | Flight, Hotel & Bus Booking System",
  meta: [
    {
      name: "description",
    ...
    {
      property: "og:title",
      content: "White Label Travel Portal Development | Complete Booking Solution",
    },
    {
      property: "og:description",
      content: "Start your travel business with our white-label booking platform. Integrated flight, hotel & bus booking with payment gateways. 3 plans: WordPress (₹1.5L), Drupal (₹2.75L), Laravel (₹4.5L).",
    },
    {
      property: "og:type",
      content: "website",
    ...
    {
      name: "twitter:title",
      content: "White Label Travel Portal Development - Flight, Hotel & Bus Booking",
    },
    {
